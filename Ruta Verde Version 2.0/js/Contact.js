...
localStorage.setItem("Contacto", "number");
localStorage.setItem("Contacto", "descripcion");
document.getElementById("nombre-txt").innerHTML = localStorage.getItem("Contacto");
document.getElementById("nombre-txt").innerHTML = localStorage.getItem("Contacto");
document.getElementById("nombre-txt").innerHTML = localStorage.getItem("Contacto");
document.getElementById("nombre-txt").innerHTML = localStorage.getItem("Contacto");
